<template>
  <form @submit.prevent="submitForm">
    ...
    <div class="form-control">
      ...
      <select id="referrer" name="referrer" v-model="reffere">
    ...
    <div class="form-control">
      ...
      <div>
        <input id="how-other" name="how" type="radio" value="radio" v-model="how"/>
    ...
    <!-- if there is only one checkbox, value will be true or false -->
    <div class="form-control">
      <input id="confirm-term" name="confirm-term" type="checkbox" v-model="confirm"/>
